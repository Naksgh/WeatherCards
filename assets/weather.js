$(document).ready(function () {
    ...
    // Create last card searched

    function createLastCard() {

        $.ajax({
            type: "GET",
            url: "https://api.openweathermap.org/data/2.5/weather?q=" + localStorage.getItem('city') + "," + localStorage.getItem('zone') + "&units=metric&APPID=4cec047c557bff34558b1d7ae6547462",
    ...
    $("#search-button").click(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                localStorage.setItem('zone', data.sys.country)
