    ...
    $("#search-button").click(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $(".country-name").append(`${data.name} in ${data.sys.country}`);
                ...
                //var weatherImage = "https://openweathermap.org/img/wn/" + data.weather[0].icon + "@2x.png";
                //$(".weather-img").attr("src", weatherImage);
            },
